      ...
      var V = (y.frame = (function () {
        ...
        S = P(function (t) {
          ...
          function r(o) {
            ...
            return (p ? C(p[1], p[2], p[3]) : o).replace(
              /#(\w)(\w)(\w)$/,
              "#$1$1$2$2$3$3"
            );
          }
              ...
              et.fallback || K.fallback
                ...
                : ((this.animate = this.transition),
                  (this.string =
                    ...
                    this.duration +
                    "ms" +
                    (this.ease != "ease" ? vt + R[this.ease][0] : "") +
          ...
          (t.init = function () {
            ...
            (t.values = function (r) {
              var s,
                o = {};
              return (
                i.call(this, r, function (p, x, K) {
                  (o[p] = x),
                    this.current[p] === void 0 &&
                      ((s = 0),
                      ~p.indexOf("scale") && (s = 1),
                      (this.current[p] = this.convert(s, K)));
                }),
                o
              );
            });
        ...
        St = P(function (t) {
          ...
          var p = { ease: R.ease[1], from: 0, to: 1 };
          (t.init = function (c) {
          ...
          (t.init = function (i) {
            ...
            (t.render = function (i) {
              ...
              for (r = o; r--; )
                (s = this.tweens[r]),
                  s.context &&
                    (s.render(i), (this.current[s.name] = s.value), (p = !0));
              return p
        ...
        function e(l) {
          ...
          function I(f) {
            var E = f.type,
              m = f.tagName;
            return !!(
              (m === "INPUT" && L[E] && !f.readOnly) ||
              (m === "TEXTAREA" && !f.readOnly) ||
              f.isContentEditable
            );
          }
          function B(f) {
          ...
          function P(f) {
            f.metaKey ||
              f.altKey ||
              f.ctrlKey ||
              (_(l.activeElement) && B(l.activeElement), (T = !0));
          }
          function R() {
            T = !1;
          }
      ...
      (ce.exports = function () {
        ...
        function T(L) {
          var _ = L.target,
            I = _.tagName;
          return (
            (/^a$/i.test(I) && _.href != null) ||
            (/^(button|textarea)$/i.test(I) && _.disabled !== !0) ||
            (/^input$/i.test(I) &&
        ...
        function X(q) {
          if (!q.getAttribute("hreflang")) {
            ...
            if (((_.href = b), !(b.indexOf(":") >= 0))) {
              ...
              if (!(b === "#" || b === "")) {
                var m =
                  _.href === L.href || b === R || (B.test(b) && U.test(R));
                $(f, I, m);
              }
            }
          }
    ...
    Me.define(
      ...
      (pe.exports = function (e) {
        ...
        (e.event.special.tap = { bindType: "click", delegateType: "click" }),
          (y.init = function (g) {
            return (
              (g = typeof g == "string" ? e(g).get(0) : g), g ? new T(g) : null
            );
          });
        function T(g) {
          var L = !1,
            ...
            if (L) {
              ...
              (U = b),
                Math.abs(f) > I &&
                  l &&
                  String(l()) === "" &&
                  (C("swipe", $, { direction: f > 0 ? "right" : "left" }), X());
            }
          }
          function W($) {
        ...
        function C(g, L, _) {
          var I = e.Event(g, { originalEvent: L });
